...
export default function MobileApp(){
  ...
  const[sectionVariants,setSectionVariants]=useState({}); // PC-only feature; carried through so mobile saves don't drop it
