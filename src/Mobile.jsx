...
function MobileColorPopover({anchor,value,defaultValue,onChange,onClose,title}){
  ...
  return (<div ref={ref} style={{position:"fixed",left,top:anchor.bottom+6,width,zIndex:2400,background:"#111116",border:"1px solid #4a4e5e",borderRadius:10,boxShadow:"0 20px 40px rgba(0,0,0,0.5)",padding:12,fontFamily:ff}}>
